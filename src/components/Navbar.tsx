...
export default function Navbar() {
  ...
  return (
    <nav className="w-[100%] p-2">
      <div className="px-6 w-[90%] mx-auto bg-[#FFFFFF] rounded-full border-black border-t-1 border-b-2 border-r-2 border-l-1  mt-4 py-2 flex justify-between items-center">
      <img src={logo} width={50} alt="" />
        <ul className="hidden md:flex justify-around items-center gap-8 text-2xl">
          {menuItems.map((item) => (
            <li
              key={item.id}
        ...
        >
          ...
          <FaTelegramPlane size={42} className="bg-[#E36127] p-2 border-black border rounded-full" />
          <FaDiscord size={42} className="bg-[#E36127] p-2 border-black border rounded-full shadow-lg" />
          <FaTwitter size={42} className="bg-[#E36127] p-2 border-black border rounded-full shadow-lg" />
        </div>
        </div>
